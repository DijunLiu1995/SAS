...
rsubmit;
option notes;
PROC PRINTTO LOG='/home/lancaster/atimsal/Daily.log' NEW;
RUN;
...
/* STEP 1: RETRIEVE DAILY TRADE AND QUOTE (DTAQ) FILES */
    ...
    data DailyNBBO;
        ...
        set nbbo.nbbom_20180426 nbbo.nbbom_20180427;

		/* Enter company tickers you want */
        where sym_root in ('AAPL','IBM') 
    ...
    data DailyQuote;
        ...
        set cq.cqm_20180426 cq.cqm_20180427;
    ...
    data DailyTrade;
        ...
        set ct.ctm_20180426 ct.ctm_20180427;
