...
/* ********************************************************************************* */
libname out "/home/lancaster/atimsal/macros/dgtw"; 
...
proc sql;
  create table out.dgtw_returns (index=(perm_dat=(permno date)))
...
proc export data=out.dgtw_returns outfile="/home/lancaster/atimsal/macros/dgtw/dgtw_returns.dta" replace;
run;
